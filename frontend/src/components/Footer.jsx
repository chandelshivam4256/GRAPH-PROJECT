    ...
    <footer className="relative bg-gradient-to-bl from-blue-900 via-indigo-800 to-slate-900 text-white py-10 mt-16 shadow-inner z-10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-5 mt-3 md:mt-0">
          <a href="https://github.com/chandelshivam4256" target="_blank" rel="noopener" className="hover:text-blue-300 transition">
            <FaGithub className="w-6 h-6" />
          </a>
          <a href="https://www.linkedin.com/in/shivam-singh-chandel-826376293" target="_blank" rel="noopener" className="hover:text-blue-300 transition">
        ...
        <p className="text-sm text-gray-200 md:text-right">
          &copy; 2025 <span className="font-semibold text-white">shivam_chandel</span>
